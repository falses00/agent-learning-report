...
const chapters = [
  ...
  { id: 'interview-map', num: 'I1', title: '大厂 Agent 面试知识地图', meta: '当前岗位 · 八域知识 · 系统设计难题 · 评分与补课', src: 'agent-runtime-gateway/00-课程总览/大厂Agent岗位面试知识地图-2026.md', group: 'start' },
  ...
  { id: 's7-lab', num: 'S7 实验', title: '可回放的 Observability 与事故闭环', meta: 'Trace · SLO · Audit chain · Incident', src: 'agent-runtime-gateway/labs/S07-observability-sre/README.md', group: 'main' },
